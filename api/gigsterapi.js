...
*/
  ...
  var query="SELECT btr_bids.bidfrom,btr_projects.*,tbl2.fname, tbl2.lname,tbl2.city ,tbl2.username, tbl3.profileimage, GROUP_CONCAT( btr_bids.bidfrom ) as bidders \
  FROM btr_projects \
